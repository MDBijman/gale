...
namespace fe::core_ast
{
	...
	node_id ast::root_id() { return root; }
	...
	node &ast::parent_of(node_id id) { return nodes.get_at(*nodes.get_at(id).parent_id); }

	std::vector<node_id> &ast::children_of(node_id id) { return nodes.get_at(id).children; }
	...
	node &ast::get_node(node_id id) { return nodes.get_at(id); }
	...
	std::optional<data_index_t> ast::create_node_data(node_type t)
	{
		...
		case node_type::JNZ:
		case node_type::JZ:
		case node_type::LABEL: return label_store.create();
		case node_type::RELATIVE_OFFSET: return relative_offset_store.create();
		case node_type::STACK_LABEL: return stack_label_store.create();
		case node_type::STACK_DEALLOC:
		case node_type::STACK_ALLOC:
		case node_type::PUSH:
		case node_type::POP: return size_store.create();
		case node_type::VARIABLE:
		case node_type::DYNAMIC_VARIABLE:
		case node_type::STATIC_OFFSET:
		case node_type::PARAM:
		case node_type::DYNAMIC_PARAM: return var_store.create();
		case node_type::RET: return return_data_store.create();
